...
public class UserController {
    ...
    @PutMapping("/v1/user-management/add-payment")
    ...
    @GetMapping("/v1/user-management/check-payment")
    ...
    @GetMapping("/v1/user-management/check-phone")
    ...
    @DeleteMapping("/v1/user-management/delete-payment")
    ...
    @DeleteMapping("/v1/user-management/delete-phone")
